-- =====================================================================
-- AutoClaim AI — AI provider + evidence pipeline schema (DDL)
-- Auto-loaded by the postgres container after 001/002 on first init.
-- Mirrors alembic/versions/003_ai_and_evidence.py and the SQLAlchemy
-- models in backend/app/models/ai.py and backend/app/models/evidence.py.
-- =====================================================================
...
-- updated_at auto-touch triggers for the new tables
DO $$
DECLARE t text;
BEGIN
    FOR t IN
